...
if ( $loop->have_posts() ) : ?>
	<div class="woocommerce">
		...
		<?php } ?>
		<?php wc_get_template( 'widget-products/'.$style.'.php' , array( 'loop'=>$loop,'columns_count'=>$columns_count,'type'=>$type,'class_column'=>$class_column,'posts_per_page'=>$number,'carousel_row'=>$carousel_row ) ); ?>
	</div>
<?php endif; ?>
