...
if(!function_exists('wpo_getAgo')){
    function wpo_getAgo($timestamp){
        ...
        if ($difference < 60) {
            return $difference.__(" seconds ago", 'fashion');
        } else {
            $difference = round($difference / 60);
        }

        if ($difference < 60) {
            return $difference.__(" minutes ago", 'fashion');
        } else {
            $difference = round($difference / 60);
        }

        if ($difference < 24) {
            return $difference.__(" hours ago", 'fashion');
        }
        else {
        ...
        if ($difference < 7) {
            return $difference.__(" days ago", 'fashion');
        } else {
            $difference = round($difference / 7);
            return $difference.__(" weeks ago", 'fashion');
        }
    }
}
