...
<div id="wpo-config">
	<p class="wpo_section page-layout">
	    ...
	    <select  name="<?php $mb->the_name(); ?>" style="display:none;">
	    	<option value="0-1-0" <?php $mb->the_select_state('0-1-0'); ?>><?php echo __('Fullwidth', 'fashion'); ?></option>
	    	<option value="1-1-0" <?php $mb->the_select_state('1-1-0'); ?>><?php echo __('Left Sidebar', 'fashion'); ?></option>
	    	<option value="0-1-1" <?php $mb->the_select_state('0-1-1'); ?>><?php echo __('Right Sidebar', 'fashion'); ?></option>
	    	<option value="1-1-1" <?php $mb->the_select_state('1-1-1'); ?>><?php echo __('Left & Right Sidebar', 'fashion'); ?></option>
	    	<option value="1-1-m" <?php $mb->the_select_state('1-1-m'); ?>><?php echo __('Left & Left Sidebar', 'fashion'); ?></option>
	    	<option value="m-1-1" <?php $mb->the_select_state('m-1-1'); ?>><?php echo __('Right & Right Sidebar', 'fashion'); ?></option>
	    </select>
	</p>
	...
	<p class="wpo_section left-sidebar">
	    ...
	    <select name="<?php $mb->the_name(); ?>">
	    	<option value=""><?php echo __('--Please Select Sidebar--', 'fashion'); ?></option>
