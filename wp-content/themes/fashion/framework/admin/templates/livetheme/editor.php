		...
		<div class="wpo-customize" id="wpo-customize">
			<div class="wrapper">
				<div id="customize-form">
					...
					<p>
						<span class="badge">
							<?php esc_html_e('Theme', 'fashion');?>: <?php echo TEXTDOMAIN; ?>
						</span>
						<?php 
							$url_back = '';
					...
					<div class="groups clearfix">
						<div class="form-group pull-left">
							<label><?php esc_html_e('Css Profiles:', 'fashion'); ?></label>
						...
						<div class="form-group ">
							<label class="show-for-notexisted"><?php esc_html_e('And Named This: ', 'fashion'); ?></label>
							<label class="show-for-existed"><?php esc_html_e('And Rename To:', 'fashion'); ?></label>
												...
												<div class="accordion-inner panel-body clearfix">
													...
													<?php  if (isset($item['type'])&&$item['type']=="image") { ?>
														<div class="form-group background-images">
															...
															<p>
																<em style="font-size:10px"><?php esc_html_e('Those Images in folder YOURTHEME/images/bg/', 'fashion') ?></em>
															</p>
