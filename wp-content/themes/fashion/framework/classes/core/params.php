				...
				switch ($option['type']) {
					...
					case 'sidebars':
						$sidebars = $GLOBALS['wp_registered_sidebars'];
			 			...
			 			$values['none'] = esc_html__('Select A Sidebar', 'fashion');
			...
			$output.='
				<div id="wpo-element-map">
					...
					<div class="vc_row-fluid googlefind">
						...
						<button class="button-primary find">'.esc_html__("Find", 'fashion').'</button>
					</div>

					<div class="row-fluid mapdetail">
						<div class="form-group">
							<label for="wpo_input_class">'.esc_html__('Latitude', 'fashion').'</label>
							<input name="lat" class="form-control wpo-latgmap" type="text" value="">
						</div>
						<div class="form-group">
							<label for="wpo_input_class">'.esc_html__('Longitude', 'fashion').'</label>
