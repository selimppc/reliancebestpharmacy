	...
	class WPO_Woocommerce{
		...
		public function woocommerce_template_loop_product_thumbnail(){
			...
			if(has_post_thumbnail()){
				...
				$output .= '<img src="'.woocommerce_placeholder_img_src().'" alt="'.__('Placeholder' , 'fashion').'" class="'.$class.'" width="'.$placeholder_width.'" height="'.$placeholder_height.'" />';
			}
			echo $output;
		}
