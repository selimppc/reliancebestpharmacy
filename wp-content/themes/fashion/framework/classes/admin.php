...
if(!class_exists('WPO_AdminTheme')){
	class WPO_AdminTheme{
		...
		public function adminLoadMenu(){
			...
			add_theme_page( $this->themeName.' | Megamenu', esc_html__("Megamenu Editor", 'fashion'), 'switch_themes', 'wpo_megamenu', array($this,'megaMenuPage') );
			if($is_vertical_menu){
				add_theme_page( $this->themeName.' | Megamenu', esc_html__("Megamenu Vertical", 'fashion'), 'switch_themes', 'wpo_megamenu_vertical', array($this,'megaMenuVerticalPage') );
			}
			add_theme_page( $this->themeName.' | Live Theme Editor ', esc_html__("Live Theme Editor", 'fashion'), 'switch_themes', 'wpo_livethemeedit', array($this,'liveThemePage') );
		}
