...
class WPO_Recent_Comment extends WPO_Widget {
    public function __construct() {
        parent::__construct(
            ...
            __('WPO Recent Comments Widget', 'fashion'),
            // Widget description
            array( 'description' => __( 'Show list of recent comments', 'fashion' ), )
        );
...
// Widget Backend
    public function form( $instance ) {
        ...
        ?>
        <p>
            <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'fashion' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'number_comment' ); ?>"><?php _e( 'Num Comments:', 'fashion' ); ?></label>
