...
class WPO_Posts extends WPO_Widget {
    public function __construct() {
        parent::__construct(
            ...
            __('WPO Posts Widget', 'fashion'),
            // Widget description
            array( 'description' => __( '', 'fashion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        ?>
        <p>
            <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php echo __( 'Title:', 'fashion' ); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'ids' ); ?>"><?php echo __( 'Posts:', 'fashion' ); ?></label>
            <br>
