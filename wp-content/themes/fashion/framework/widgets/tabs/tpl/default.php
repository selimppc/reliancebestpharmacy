<ul class="nav nav-tabs">
	<?php if($show_popular_posts == 'true'): ?>
		<li class="active">
			<a href="#tab-popular" data-toggle="tab"><?php echo __('Popular', 'fashion' ); ?></a>
		</li>
	<?php endif; ?>
	<?php if($show_recent_posts == 'true'): ?>
		<li <?php if($show_popular_posts != 'true') echo 'class="active"'; ?>>
			<a href="#tab-recent" data-toggle="tab"><?php echo __('Recent', 'fashion' ); ?></a>
		</li>
	<?php endif; ?>
	<?php if($show_comments == 'true'): ?>
		<li <?php if($show_popular_posts != 'true' && $show_recent_posts != 'true' ) echo 'class="active"'; ?>>
			<a href="#tab-comments" data-toggle="tab"><?php echo __('Comments', 'fashion' ); ?></a>
		</li>
	<?php endif; ?>
</ul>
		...
		<div class="tab-pane" id="tab-comments">
			<div class="comment-widget">
				...
				<article class="clearfix">
					...
					<h6>
						<?php echo strip_tags($comment->comment_author); ?> <?php __('says', 'fashion' ); ?>:
					</h6>
