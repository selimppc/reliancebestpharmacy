...
class WPO_Recent_Post extends WPO_Widget {
    public function __construct() {
        parent::__construct(
            ...
            __('WPO Recent Posts Widget', 'fashion'),
            // Widget description
            array( 'description' => __( 'Show list of recent post', 'fashion' ), )
        );
...
// Widget Backend
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'number_post' ); ?>"><?php _e( 'Num Posts:', 'fashion' ); ?></label>
