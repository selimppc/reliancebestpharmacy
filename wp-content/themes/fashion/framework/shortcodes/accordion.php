 ...
 */
	...
	class WPO_Shortcode_Accordion extends WPO_Shortcode_Base{
		...
		public function getButton( $data=null ){
			$button = array(
				'icon'	 => 'accordion',
				'title' => esc_html__( 'Accoridion List' , 'fashion'),
				'desc'  => esc_html__( 'Display Accordion List Supported By Bootstrap 3' , 'fashion'),
				'name'  => $this->name
			);
			return $button;
		}
